const jokes = [
  ...
  let jokeColor=["green","red","blue","cyan","orange","yellow"]

  let colour=(jokeColor[Math.floor(Math.random()*jokeColor.length-1)+1])
  console.log(colour)

  let i=Math.floor(Math.random()*jokes.length)

  let jokeOfTheDay=jokes[i]

  let joke1=document.getElementsByName("joke")[0]

  joke1.style.color=colour
  joke1.innerHTML=`"${jokeOfTheDay}"`

//   document.getElementsByName("joke")[0].style.color=colour
//   document.getElementsByName("joke")[0].innerHTML=jokeOfTheDay
